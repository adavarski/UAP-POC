...
## Productionalize SaaS: k8s (KOPS, Rancher:k3s/RKE)

k8s-based data-driven Analytics/ML/DeepML SaaS platform provisioning : KOPS(AWS), Rancher(custom provisioning/SaaS deploy):k3s(for development)/RKE on AWS/Azure/GCP/OCP, AWS EKS/Azure AKS/Google GKE/Oracle OKE
