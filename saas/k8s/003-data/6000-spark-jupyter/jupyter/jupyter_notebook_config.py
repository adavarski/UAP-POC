...
if os.environ.get('OBJECTS_ACCESSID'):
    ...
    # Which storage classes will be used for which paths
    c.HybridContentsManager.manager_classes = {
        "": FileContentsManager,
        "remote": S3ContentsManager,
    }

    # S3 Access options
    S3MANAGER_OPTIONS = {
        'access_key_id': os.environ["OBJECTS_ACCESSID"],
        'secret_access_key': os.environ["OBJECTS_SECRET"],
        'bucket': os.environ["OBJECTS_CONTAINER"],
        'prefix': posixpath.join('notebooks',  os.environ.get("HOSTNAME", '')) + '/',
    }

    if os.environ.get('OBJECTS_ENDPOINT'):
        S3MANAGER_OPTIONS['endpoint_url'] = os.environ.get('OBJECTS_ENDPOINT')

    c.HybridContentsManager.manager_kwargs = { "": {}, "remote": S3MANAGER_OPTIONS }
...
#  they are limited.
#c.NotebookApp.iopub_data_rate_limit = 2.0.000
